 ...
 * @param {number} chunkRatio - Ratio of base chunk to seqSize (0 to 1, e.g. 0.25 = quarter)
 ...
 */
function genRepeat(seqSize, chunkRatio, bias = 0) {
  let chunkSize = Math.max(1, Math.round(seqSize * chunkRatio));
